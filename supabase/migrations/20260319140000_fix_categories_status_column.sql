-- ============================================================
-- Fix: Drop bare auto-created tables and recreate with full schema
-- The tables exist but only have id (bigint) + created_at columns.
-- All previous migrations were discarded. This migration rebuilds
-- the full schema from scratch.
-- ============================================================

-- 1. Drop bare tables (they have no useful data)
DROP TABLE IF EXISTS public.bundles CASCADE;
DROP TABLE IF EXISTS public.categories CASCADE;

-- 2. Drop and recreate ENUM types cleanly
...
BEGIN
    ...
    (
        ...
        'The ultimate sci-fi content pack with 200+ reels featuring robots, spaceships, futuristic cities, and more.',
